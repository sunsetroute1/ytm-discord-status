...
**Jellyfin** is supported for music/films/TV via Media Player or the web UI. Browser Jellyfin sessions are detected as title-only + long runtime; other browser tabs still need a music catalog match.
